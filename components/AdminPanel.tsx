      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 text-center shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col items-center gap-4 relative z-10">
                ...
                <div>
                    <h2 className="text-slate-400 text-sm font-semibold tracking-wider uppercase">Active Participants</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            >
                <div className="flex flex-col items-center gap-4">
                    ...
                    <span className="text-2xl font-bold text-white group-hover:text-green-400 transition-colors">START DRAW</span>
                </div>
            </button>
            ...
            >
                <div className="flex flex-col items-center gap-4">
                    ...
                    <span className="text-2xl font-bold text-white group-hover:text-red-400 transition-colors">RESET GAME</span>
                </div>
            </button>
        </div>
        ...
        {gameState.winner && (
            <div className="bg-slate-900/50 rounded-2xl p-6 border border-slate-800 flex items-center gap-6 animate-in slide-in-from-bottom-4">
                ...
                <div>
                    <div className="text-sm text-slate-500">Last Winner</div>
